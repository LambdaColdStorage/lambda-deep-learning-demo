...
class TextGenerationWordInputter(Inputter):
  def __init__(self, config, augmenter):
    super(TextGenerationWordInputter, self).__init__(config, augmenter)
...
def build(config, augmenter):
  return TextGenerationWordInputter(config, augmenter)
